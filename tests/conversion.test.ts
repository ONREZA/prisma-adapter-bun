...
import { fieldToColumnType, mapArg, resultNormalizers, inferOidFromValue, findFirstNonNullInColumn, toPgArrayLiteral, PgOid, UnsupportedNativeDataType } from '../src/conversion.ts'
...
describe('mapArg', () => {
  test('passes null through', () => {
    ...
    expect(mapArg(undefined, { scalarType: 'string', arity: 'scalar' })).toBeNull()
  })
  ...
  test('converts datetime strings to formatted date strings', () => {
    const result = mapArg('2024-06-15T12:30:45.123Z', { scalarType: 'datetime', arity: 'scalar' })
    expect(result).toBe('2024-06-15 12:30:45.123')
  })

  test('converts datetime strings with dbType DATE', () => {
    const result = mapArg('2024-06-15T12:30:45.123Z', { scalarType: 'datetime', dbType: 'DATE', arity: 'scalar' })
    expect(result).toBe('2024-06-15')
  })

  test('converts datetime strings with dbType TIME', () => {
    const result = mapArg('2024-06-15T12:30:45.123Z', { scalarType: 'datetime', dbType: 'TIME', arity: 'scalar' })
  ...
  test('maps list of strings to PG array literal', () => {
    const result = mapArg(['hello', 'world'], { scalarType: 'string', arity: 'list' })
